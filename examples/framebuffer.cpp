...
int main(int argc, char *argv[]) {
    ...
    my_app.set_window_title("framebuffer");
    ...
    gxm::gl_framebuffer fb(my_app.main_window_size());

    gxm::gl_context::instance().set_depth_test_enable(false);

    my_app.set_update([&triangle, &fb]() {
        gxm::gl_framebuffer::push(fb);
        fb.clear();
        triangle.draw();
